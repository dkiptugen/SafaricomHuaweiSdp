...
class config
	{
		...
		public $kmp_start_stop_sms_notification_service_log_soap_messages=0; // log request and responses to the server
		...
		public $kmp_send_sms_notify_service_endpoint="https://146.177.33.52/sg_sms/nxsx_007.php";
		...
		public $kmp_send_sms_service_debug=1; // 1 - debug string to be included, 0 do not include debug str. The $kmp_send_sms_service_log_soap_messages must be set to 1
		...
		public $kmp_get_sms_delivery_status_service_log_soap_messages=0; // log request and responses to the server
