...
$kmp_start_stop_sms_notification_service_endpoint="http://svc.safaricom.com:8310/SmsNotificationManagerService/services/SmsNotificationManager"; //endpoint on SDP
...
$kmp_start_stop_sms_notification_service_debug=1; // 1 - debug string to be included, 0 do not include debug str. 

//sendSMS Configs
$kmp_send_sms_service_endpoint="http://svc.safaricom.com:8310/SendSmsService/services/SendSms"; //endpoint on SDP
$kmp_send_sms_notify_delivery=1; // 1 - send delivery receipts to $kmp_sms_notify_service_endpoint, 0 do not send
$kmp_send_sms_notify_service_endpoint="http://kilele.co.ke/kempes/notifyservice.php";
...
$kmp_get_sms_delivery_status_service_endpoint="http://svc.safaricom.com:8310/SendSmsService/services/SendSms"; //endpoint on SDP
...
$kmp_get_sms_delivery_status_service_debug=1; // 1 - debug string to be included, 0 do not include debug str.
